...
public class OniEmitterControl : MonoBehaviour {
	...
	void Start()
	{
		this.audio.PlayOneShot(this.EmitSound);
	}
	...
	void 	Update()
	{
		...
		do {
			...
			oni.rigidbody.velocity        = Vector3.down*1.0f;
			oni.rigidbody.angularVelocity = initial_rotation*Vector3.forward*5.0f*(this.oni_num%3);
