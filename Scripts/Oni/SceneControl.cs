...
public class SceneControl : MonoBehaviour {
	...
	// 2D用的纹理
	public Texture	TitleTexture = null;			// “开始”
	public Texture	StartTexture = null;			// “开始”
	public Texture	ReturnButtonTexture = null;		// “返回”按钮
	...
	void	Update()
	{
		...
		switch(this.step) {
			...
			case STEP.RESULT_DEFEAT:
			{
				...
				{
					// SE（“咚咚”）
					this.audio.PlayOneShot(this.EvalSound);
				}
				// 等待评价显示结束
				//
			...
			case STEP.GAME_OVER:
			{
				...
				if(Input.GetMouseButtonDown(0)) {
					...
					this.audio.PlayOneShot(this.ReturnSound);
